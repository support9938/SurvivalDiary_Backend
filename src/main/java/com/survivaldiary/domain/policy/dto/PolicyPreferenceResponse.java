...
public record PolicyPreferenceResponse(
        ...
        @Schema(description = "취업 상태") String employmentStatus,
        @Schema(description = "소득 구간. 전체면 null") String incomeRange,
        @Schema(description = "정책 분야. 전체면 null") String category
) {
    public static PolicyPreferenceResponse empty(Integer age) {
        return new PolicyPreferenceResponse(false, age, null, null, null, null, null);
    }
